...
@section('content')
    ...
    <div class="banner py-0 pq-revsection">
        ...
        <rs-module-wrap id="rev_slider_4_1_wrapper" data-alias="slider-4" data-source="gallery"
            ...
            <rs-module id="rev_slider_4_1" data-version="6.6.18">
                <rs-slides style="overflow: hidden; position: absolute;">
                    <rs-slide style="position: absolute;" data-key="rs-6" data-title="Slide" data-in="o:0;sx:0.6;sy:0.6;"
                        ...
                        <rs-layer id="slider-4-slide-6-layer-3" class="rev-btn" data-type="button" data-rsp_ch="on"
                            ...
                            data-padding="r:25,21,16,10;l:25,21,16,10;" data-border="bor:25px,25px,25px,25px;"
                        ...
                        <rs-layer id="slider-4-slide-6-layer-4" class="rev-btn" data-type="button" data-rsp_ch="on"
                            ...
                            data-text="w:normal;s:17,14,10,6;l:40,33,25,15;fw:500;" data-dim="minh:0px,none,none,none;"
                            data-frame_0="x:-50,-41,-31,-19;" data-frame_1="st:1700;sp:1000;sR:1700;"
                            ...
                            <a class="pq-button pq-button-flat" href="https://bit.ly/InspiredVisionAfricaReg">
                                ...
                                <svg class="svg" height="100%" width="100%" viewBox="0 0 100 100"
                                    ...
                                    <path d="M0 0 H 100 V 100 H 00 Z" fill="transparent" stroke="black"
                                        ...
                                        style="stroke-dashoffset: 285.59px;"></path>
                                </svg>
                            </a>
                        </rs-layer>
    ...
    <!-- Banner -->
    <div class="pq-counter-section-page-1 wow fadeInUp pq-section-gap">
        <div class="container">
            <div class="pq-counter-wrapper">

                <!-- Counter 1 -->
                <div class="pq-counter-box left-counter">
                    <div class="pq-counter-info">
                        <span class="counts">5</span>
                        <span class="suffix">+</span>
                        <div>INSPIRING SPEAKERS</div>
                        <svg class="svg" height="100%" width="100%" viewBox="0 0 100 100"
                            preserveAspectRatio="none">
                ...
                <!-- Counter 3 -->
                <div class="pq-counter-box right-counter">
                    <span class="counts">10</span>
                    <span class="suffix">+</span>
                    <div>WORKSHOPS & SESSIONS</div>
                    <svg class="svg" height="100%" width="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <path d="M0 0 H 100 V 100 H 0 Z" fill="transparent" stroke="black"
                            vector-effect="non-scaling-stroke" stroke-dasharray="400"></path>
                    </svg>
    ...
    <section class="pq-designer-page-1 wow fadeIn">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="pq-section-title text-center">
                        <div class="pq-title">
                            <h5 class="pq-title-heading">
                                WE BRING TOGETHER YOUNG LEADERS & VISIONARY
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pq-event-wrapper">
                        <div class="pq-event-list-1 pq-click-active">
                            <!-- Event 1 -->
                            <div class="pq-event-box pq-style-1 pq-click-item pq-active">
                                ...
                                <div class="pq-event-box-info">
                                    <h5 class="pq-event-box-title">Unleash Greatness Conference</h5>
                                    <p class="pq-event-box-description">Join us for the first edition of Inspire Vision
                                        Africa’s Youth Conference in Abidjan, Côte d’Ivoire — themed <strong>“Unleash
                            ...
                            <div class="pq-event-box pq-style-1 pq-click-item">
                                ...
                                <div class="pq-event-box-info">
                                    ...
                                    <p class="pq-event-box-description">Experience practical workshops designed to develop
                            ...
                            <div class="pq-event-box pq-style-1 pq-click-item">
                                ...
                                <div class="pq-event-box-info">
                                    ...
                                    <p class="pq-event-box-description">Meet and connect with like-minded youth,
                            ...
                            <div class="pq-event-box pq-style-1 pq-click-item">
                                ...
                                <div class="pq-event-box-info">
                                    ...
                                    <p class="pq-event-box-description">Hear from inspiring speakers and mentors who are
